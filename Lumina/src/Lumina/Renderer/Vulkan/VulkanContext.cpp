...
namespace Lumina 
{
	...
	void VulkanContext::Init(GLFWwindow* window)
	{
		...
		// Surface: Maybe add to class member 
		VkSurfaceKHR surface;

		// Create Suface 
		{
			err = glfwCreateWindowSurface(m_Instance, m_Window, m_Allocator, &surface);
			CheckResult(err);
		}
		...
		// Create Context and IO: This may not need to happen in this order
		{
			IMGUI_CHECKVERSION();
			ImGui::CreateContext();
