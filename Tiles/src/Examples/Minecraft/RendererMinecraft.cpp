#include "RendererMinecraft.h"

#include "Lumina/OpenGL/GLUtils.h"
#include "Lumina/Geometry/Cube.h"

RendererMinecraft::RendererMinecraft()
{
...
void RendererMinecraft::Render(Camera& camera, GL::ShaderProgram& shader)
{
    m_Texture.Bind();
    m_DepthBuffer.Bind();
    m_FrameBuffer.Bind();
...
void RendererMinecraft::SetViewportSize(const float width, const float height)
{
    m_Width = width;
    m_Height = height;
